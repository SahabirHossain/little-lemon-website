...
const schema = yup.object({
    ...
    telephone: yup.string().required("Telephone is a required field!").matches(/^(\+\d{2,4}\s)?\(?\d{4}\)?[\s.-]\d{4}[\s.-]\d{3}$/, "Phone number must match the form 0170 0000 000"),
        ...
        <form onSubmit={handleSubmit(formSubmit)}>
            <fieldset>
                ...
                <div className="field">
                    ...
                    <input type="tel" placeholder="0170 0000 000" name="telephone" {...register("telephone")} />
